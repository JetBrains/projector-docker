...
echo "rm -rf $pluginsDir/projector-plugin-markdown" >> "$mdPluginEnablerFile"
echo "cp -r /projector/projector-plugin-markdown $pluginsDir/projector-plugin-markdown" >> "$mdPluginEnablerFile"
."$mdPluginEnablerFile"
